...
plot \
     'clmcn1a-obs-0.tec' using 1:($5*1000) title 'Lit1-N=1' with lines ls 1, \
     'clmcn1a-obs-0.tec' using 1:($7*1000) title 'Lit2-N=1' with lines ls 2, \
     'clmcn1a-obs-0.tec' using 1:($9*1000) title 'Lit3-N=1' with lines ls 3, \
...
plot \
     'clmcn1a-obs-0.tec' using 1:($11*1000) title 'SOM1-N=1' with lines ls 1, \
     'clmcn1a-obs-0.tec' using 1:($12*1000) title 'SOM2-N=1' with lines ls 2, \
     'clmcn1a-obs-0.tec' using 1:($13*1000) title 'SOM3-N=1' with lines ls 3, \
     'clmcn1a-obs-0.tec' using 1:($14*1000) title 'SOM4-N=1' with lines ls 4, \
...
set yrange[0:1]
plot \
     'clmcn1a-obs-0.tec' using 1:($3+$5+$7+$9+$11+$12+$13+$14)*1000 title 'C total-N=1' with lines ls 1, \
     'clmcn1a-obs-0.tec' using 1:($5+$7+$9+$11+$12+$13+$14)*1000 title 'C left-N=1' with lines ls 2, \
     'clmcn1a-obs-0.tec' using 1:($3*1000) title 'C mineralized-N=1' with lines ls 3, \
...
set ylabel 'Concentration [mmol/m^3]' 
plot \
     'clmcn1a-obs-0.tec' using 1:($6+$8+$10+$11*0.071429+$12*0.071429+$13*0.085714+$14*0.085714+$4)*1e3 title 'N total-N=1' with lines ls 1, \
     'clmcn1a-obs-0.tec' using 1:($6+$8+$10+$11*0.071429+$12*0.071429+$13*0.085714+$14*0.085714)*1e3 title 'N left-N=1' with lines ls 2, \
     'clmcn1a-obs-0.tec' using 1:($4*1e3) title 'Mineral N-N=1' with lines ls 3, \
