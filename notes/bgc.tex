...
! upstream CN
    write(*, *) this%Upstream%name_c, this%Upstream%name_n, this%Upstream%ratio_cn, this%upstream_ispec_n
    if(this%upstream_ispec_n > 0) then
       if(rt_auxvar%immobile(this%upstream_ispec_c) .LE. 1.0d-10) then
          write(option%fid_out,*) 'Upstream C concentration is 0 in CN ratio calculation, 1.d-40 is used instead.'
       endif 
