...
plot [0:100] exp(-0.07*x) title 'SOM1-Analytical' with lines ls 4, \
     0.72*(1-exp(-0.07*x)) title 'SOM2-Analytical' with lines ls 5, \
     0.28*(1-exp(-0.07*x)) title 'CO2-Analytical' with lines ls 6, \
     'som1-obs-0.tec' using 1:($5*1000) title 'Lit1 (CLM-DECOMP)' with lines ls 1, \
     'som1-obs-0.tec' using 1:($6*1000) title 'SOM1 (CLM-DECOMP)' with lines ls 2, \
     'som1-obs-0.tec' using 1:($4*250*1000) title 'CO2 (CLM-DECOMP)' with lines ls 3
