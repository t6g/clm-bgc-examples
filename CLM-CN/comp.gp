...
plot \
     ...
     'CLM-CN-0-obs-0.tec' using 1:($9*1000) title 'Litter1-N=4' with lines ls 5, \
     'CLM-CN-0-obs-0.tec' using 1:($10*1000) title 'Litter2-N=4' with lines ls 6, \
     'CLM-CN-0-obs-0.tec' using 1:($11*1000) title 'Litter3-N=4' with lines ls 7
...
plot \
     ...
     'CLM-CN-0-obs-0.tec' using 1:($5*1000) title 'SOM1-N=4' with lines ls 5, \
     'CLM-CN-0-obs-0.tec' using 1:($6*1000) title 'SOM2-N=4' with lines ls 6, \
     'CLM-CN-0-obs-0.tec' using 1:($7*1000) title 'SOM3-N=4' with lines ls 7, \
     'CLM-CN-0-obs-0.tec' using 1:($8*1000) title 'SOM4-N=4' with lines ls 8
...
plot \
     ...
     'CLM-CN-0-obs-0.tec' using 1:($4+$5+$6+$7+$8+$9+$10+$11)*1000 title 'C total-N=4' with lines ls 5, \
     'CLM-CN-0-obs-0.tec' using 1:($5+$6+$7+$8+$9+$10+$11)*1000 title 'C left-N=4' with lines ls 6, \
     'CLM-CN-0-obs-0.tec' using 1:($4*1000) title 'C mineralized-N=4' with lines ls 7
...
plot \
     ...
     'CLM-CN-0-obs-0.tec' using 1:($12+$13+$14+$5*0.071429+$6*0.071429+$7*0.085714+$8*0.085714+$3)*1e3 title 'N total-N=4' with lines ls 5, \
     'CLM-CN-0-obs-0.tec' using 1:($12+$13+$14+$5*0.071429+$6*0.071429+$7*0.085714+$8*0.085714)*1e3 title 'N left-N=4' with lines ls 6, \
     'CLM-CN-0-obs-0.tec' using 1:($3*1e3) title 'Mineral N-N=4' with lines ls 7
