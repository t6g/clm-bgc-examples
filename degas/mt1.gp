...
plot 'mt1-obs-0.tec' using 1:($4*1000) title 'CO2(aq)' with lines ls 1, \
     'mt1-obs-0.tec' using 1:(($5-1)/250*1000) title 'CO2(g)' with lines ls 2, \
     'mt1-obs-0.tec' using 1:($4*1000+($5-1)/250*1000) title 'total' with lines ls 3
